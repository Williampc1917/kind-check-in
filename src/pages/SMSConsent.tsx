...
const optInSteps = [
  "A MadeIt: Safety Check-Ins user adds a trusted contact in the app.",
  ...
  "The contact must reply YES to agree to receive MadeIt: Safety Check-Ins SMS/text messages about the user's safety check-ins.",
  "MadeIt records the YES reply and marks the contact as confirmed.",
  "Only confirmed contacts can receive MadeIt: Safety Check-Ins safety alert SMS messages.",
];
...
const messageSamples = [
  {
    ...
    description: "This is the first SMS MadeIt: Safety Check-Ins sends to a trusted contact. The name changes based on the user's display name.",
  ...
  },
  {
    ...
    description: "MadeIt: Safety Check-Ins sends safety alerts only to trusted contacts who have replied YES.",
    body: "MadeIt: Sarah hasn't checked in for Walking Home - due by 11:30 PM.",
  },
  {
    title: "Safety alert with a personal note",
    description: "A MadeIt: Safety Check-Ins user may include a personal note with an alert.",
...
const messageTypes = [
  ...
  "account alerts related to MadeIt: Safety Check-Ins",
  "safety alerts when a MadeIt: Safety Check-Ins user misses a check-in deadline",
  "user-triggered trusted contact and emergency-contact notifications",
...
const SMSConsent = () => {
  return (
    <InfoPageLayout
      title="SMS Consent for MadeIt: Safety Check-Ins"
      subtitle="This public page explains how trusted contacts opt in before receiving MadeIt: Safety Check-Ins SMS safety alerts."
      meta="Public SMS consent proof • Stable URL /sms-consent"
    >
      <div className="space-y-10">
        <section className="border-b border-slate-200 pb-8">
          <div className="space-y-4 text-[1rem] leading-7 text-slate-600">
            <p className="rounded-2xl border border-slate-200 bg-slate-50 px-5 py-4 text-slate-700">
            ...
            <p>
              SMS is used for safety check-ins, account alerts, and user-triggered trusted contact/emergency-contact notifications. No third-party marketing: MadeIt: Safety Check-Ins does not sell or share mobile phone numbers or SMS consent information with third parties or affiliates for marketing or promotional purposes.
            </p>
          </div>
        </section>
        ...
        <section className="border-b border-slate-200 pb-8">
          ...
          <div className="mt-4 space-y-4 text-[1rem] leading-7 text-slate-600">
            <p>
              MadeIt: Safety Check-Ins is a personal safety check-in app. A user can add trusted contacts,
            ...
            <p className="font-semibold text-slate-900">
              ...
              give consent by replying YES to the MadeIt: Safety Check-Ins consent request SMS.
            </p>
            <p>
              Adding a phone number in the MadeIt: Safety Check-Ins app does not by itself opt that contact into
              alerts. Imported contacts and manually entered contacts follow the same consent
              process.
            </p>
            <p>
              Message frequency varies based on your use of the app. Message and data rates may apply. Reply STOP to opt out and HELP for help.
            </p>
          </div>
        </section>
        ...
        <section className="border-b border-slate-200 pb-8">
          ...
          <p className="mt-5 text-[1rem] leading-7 text-slate-600">
            ...
            safety alerts. The MadeIt: Safety Check-Ins user may resend the consent request from the app, subject to
        ...
        <section className="border-b border-slate-200 pb-8">
          ...
          <p className="mt-4 text-[1rem] leading-7 text-slate-600">
            The MadeIt: Safety Check-Ins trusted contacts screen shows each contact's consent status so the user
        ...
        <section className="border-b border-slate-200 pb-8">
          ...
          <div className="mt-4 space-y-4 text-[1rem] leading-7 text-slate-600">
            ...
            <p>
              Trusted contacts can reply HELP for help with MadeIt: Safety Check-Ins SMS messages.
            </p>
            <p>
        ...
        <section className="border-b border-slate-200 pb-8">
          ...
          <p className="mt-4 text-[1rem] leading-7 text-slate-600">
            Message frequency varies based on how often the MadeIt: Safety Check-Ins user starts check-ins, whether
            they miss a deadline, and how many confirmed trusted contacts they have. Message and data rates may apply.
          </p>
        </section>
        ...
        <section className="border-b border-slate-200 pb-8">
          ...
          <p className="mt-4 text-[1rem] leading-7 text-slate-600">
            MadeIt: Safety Check-Ins is not an emergency service and is not a substitute for 911, emergency medical
        ...
        <section>
          ...
          <div className="mt-4 space-y-4 text-[1rem] leading-7 text-slate-600">
            <p>
              MadeIt: Safety Check-Ins does not sell or share mobile phone numbers or SMS consent information with
              third parties or affiliates for marketing or promotional purposes.
            </p>
            <p>
              This page is public, stable, and viewable without login, app install, cookies, or
              any gated flow. Review the MadeIt: Safety Check-Ins{" "}

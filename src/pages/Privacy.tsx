...
const sections = [
  {
    ...
    paragraphs: [
      "Account information: When you create a SafeCheck account, we collect your email address and the display name you provide during onboarding. If you sign in with Google, we receive your Google account email via OAuth. Apple Sign-In may provide a private relay email address.",
  ...
  },
  {
    ...
    paragraphs: [
      "We use your information to operate SafeCheck: to authenticate you, run check-in timers, deliver push notifications to your device, send SMS alerts to your trusted contacts when a check-in is missed, and send you a resolved update when you check in safely.",
      "Your display name is included in SMS messages sent to your trusted contacts so they know who the alert is from. For example: 'Safecheck: [Your Name] hasn't checked in for Walking Home — due by 11:30 PM.'",
  ...
  },
  {
    ...
    paragraphs: [
      "SafeCheck sends SMS text messages to the trusted contacts you designate in the app. These messages are transactional safety alerts — not marketing. We send four types of SMS: (1) a consent request asking the contact if they agree to receive alerts, (2) an opt-in confirmation once they accept, (3) escalation alerts if you miss a check-in deadline, and (4) a resolved update when you mark yourself safe.",
      "No SMS messages are sent to a contact until they have consented. When you add a trusted contact, SafeCheck sends them a one-time consent request: 'Sarah added you as a safety contact on Safecheck. If they don't check in safely, you'll receive a text alert. Reply YES to accept or STOP to decline.' Only contacts who reply YES receive any further messages.",
      "Contacts can withdraw consent at any time by replying STOP to any message from SafeCheck. This immediately removes them from all future alerts. Contacts who previously opted out can reinstate their consent by replying START or UNSTOP.",
      ...
      "SafeCheck is not an emergency service. SMS alerts are informational notifications to personal contacts you have chosen. If you are in danger, contact local emergency services.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Apple Push Notification service (APNs) — delivers push notifications to your iOS device. APNs receives your device push token, which SafeCheck registers on each app launch. Apple privacy policy: apple.com/privacy.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "You may request deletion of your account and associated personal data by contacting support@safecheck.app. Account deletion cascades to all personal data: profile, devices, contacts, check-in history, and consent records. Anonymized audit rows are retained as described above.",
    ],
  },
  {
    title: "Your Rights and Choices",
    paragraphs: [
      "Opt out of SMS at any time: If you are a trusted contact who has received messages from SafeCheck, reply STOP to any SafeCheck message to immediately opt out. No further messages will be sent. Reply START or UNSTOP to re-enable messages.",
      ...
      "Access and correction: You may request a copy of the personal data we hold about you by emailing support@safecheck.app. You may also update your display name, time zone, and notification preferences directly in the app.",
      "Account deletion: To delete your account and all associated personal data, email support@safecheck.app. We will process deletion requests within a reasonable timeframe.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "No system is perfectly secure. We cannot guarantee absolute security, and we encourage you to use a strong, unique email account for your SafeCheck login.",
    ],
  },
  {
    title: "Children's Privacy",
    paragraphs: [
      "SafeCheck is not intended for use by children under the age of 13. We do not knowingly collect personal information from children under 13. If you believe we have inadvertently collected such information, please contact support@safecheck.app and we will delete it promptly.",
    ],
  },
  {
    title: "Changes to This Policy",
    paragraphs: [
      "We may update this Privacy Policy from time to time. When we do, we will update the effective date at the top of this page. For significant changes, we will notify you through the app or by email. Continued use of SafeCheck after changes take effect constitutes your acceptance of the updated policy.",
    ],
  },
  {
    title: "Contact",
    paragraphs: [
      "For privacy questions, data requests, or to exercise your rights, contact us at support@safecheck.app. We aim to respond to all requests within 30 days.",
    ],
  },
];
...
const Privacy = () => {
  return (
    <InfoPageLayout
      ...
      subtitle="This policy explains what data SafeCheck collects, how it is used, and the choices available to you and your trusted contacts."
